...
mod nyumba {
    ...
    impl Nyumba {
        ...
        #[ink(message)]
        pub fn get_all_users(&self) -> Result<Vec<UserData>, ()> {
        ...
        pub fn register_asset(
            ...
            let asset_data = AssetData::new_asset(
                caller,
                new_property_id,
                property_name,
                property_location,
        ...
        pub fn purchase_asset(&mut self, property_id: String, amount: u128) -> bool {
            ...
            *buyer_tokens_owned += tokens_to_buy;
            ...
            let result = self
                .erc20
                .transfer_from(seller.clone(), buyer.clone(), transfer_amount);
            if result.is_err() {
                *buyer_tokens_owned -= tokens_to_buy;
                return false;
            }
    ...
    mod tests {
        ...
        fn add_owner_works() {
            ...
            // Assert
            assert_eq!(
                owner_register.get_user(account_id),
                Some(UserData {
                    name,
                    email,
                    account_id
        ...
        fn register_asset_test() {
            ...
            // Assert
            assert_eq!(
                contract.get_asset(property_id),
                Some(AssetData {
                    property_owner,
                    property_id: new_property_id,
                    property_name,
            ...
            assert_eq!(
                retrieved_asset_data_sold.token_supply,
                (token_supply_1 - 100)
            );
        }
